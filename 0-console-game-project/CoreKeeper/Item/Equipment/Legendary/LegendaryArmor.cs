...
public class LegendaryArmor : Item, IInventoryItem, IEquippable, IDroppable
{
    ...
    public LegendaryArmor(Scene scene, Map map, int tileX, int tileY, int hpBonus) : base(scene)
    {
