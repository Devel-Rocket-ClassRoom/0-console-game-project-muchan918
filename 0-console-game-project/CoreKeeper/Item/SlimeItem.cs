...
public class SlimeItem : Item, IDroppable, IInventoryItem
{
    ...
    public SlimeItem(Scene scene, Map map, int tileX, int tileY) : base(scene)
    {
        Name = "Slime";
        _map = map;
        TileX = tileX;
    ...
    public override void Draw(ScreenBuffer buffer)
    {
        ...
        buffer.SetCell(sx + 1, sy + 1, '▚', ConsoleColor.Green, ConsoleColor.Black);
        buffer.SetCell(sx + 2, sy + 1, '▛', ConsoleColor.Green, ConsoleColor.Black);
    }
